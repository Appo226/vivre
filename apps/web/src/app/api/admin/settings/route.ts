...
const UpdateSettingsSchema = z.object({
  ...
  event_listing_fee_fcfa: z.number().int().min(0).optional(),
  ad_price_photo_fcfa_per_day: z.number().int().min(0).optional(),
  ad_price_video_fcfa_per_day: z.number().int().min(0).optional(),
