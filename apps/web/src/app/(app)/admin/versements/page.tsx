  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
      <div className="flex items-start justify-between">
        <div>
          <p className="font-jakarta font-bold text-gray-900">{p.event.title}</p>
      ...
      {paying ? (
        <div className="mt-4 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setPaying(false)} className="px-4 text-sm font-semibold text-gray-500">Annuler</button>
          </div>
        </div>
      ) : (
        <button
      ...
      <div className="px-4 md:px-8 mt-5 md:mt-8 md:max-w-5xl">
        ...
        {!loading && payouts.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 text-sm">Aucun versement éligible pour l&apos;instant.</p>
          </div>
        )}
